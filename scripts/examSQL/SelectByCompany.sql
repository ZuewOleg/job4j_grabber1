...
select p.name as "Не состоят в 5 компании" from person p where company_id != 5;
select * from person where company_id != 5;
select p.name as "Имя сотрудника", c.name as "Название компании", c.id "Номер компании"
